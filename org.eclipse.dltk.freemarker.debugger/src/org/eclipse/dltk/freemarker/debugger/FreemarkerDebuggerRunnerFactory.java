...
/**
 * Factory responsible for creating instances of Freemarker debugging
 * engine.
 */
public class FreemarkerDebuggerRunnerFactory implements
		IInterpreterRunnerFactory {

	public IInterpreterRunner createRunner(IInterpreterInstall install) {
		return new FreemarkerDebuggerRunner(install);
	}
}
