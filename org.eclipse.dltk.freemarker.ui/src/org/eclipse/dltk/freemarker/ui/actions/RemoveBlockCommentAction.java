...
/**
 * Action that removes the enclosing comment marks from a FTL block comment.
 * 
 */
public class RemoveBlockCommentAction extends BlockCommentAction {
	...
	/*
	 * @see
	 * org.eclipse.jdt.internal.ui.actions.AddBlockCommentAction#runInternal
	 * (org.eclipse.jface.text.ITextSelection,
	 * org.eclipse.jface.text.IDocumentExtension3,
	 * org.eclipse.jdt.internal.ui.actions
	 * .AddBlockCommentAction.Edit.EditFactory)
	 */
	protected void runInternal(ITextSelection selection,
		...
		ITypedRegion partition = docExtension.getPartition(
				IFreemarkerPartitions.FREEMARKER_PARTITIONING, offset, false);
		int partOffset = partition.getOffset();
		int partEndOffset = partOffset + partition.getLength();

		while (partEndOffset < endOffset) {

			if (partition.getType() == IFreemarkerPartitions.FREEMARKER_COMMENT) {
	...
	/*
	 * @see
	 * org.eclipse.jdt.internal.ui.actions.AddBlockCommentAction#validSelection
	 * (org.eclipse.jface.text.ITextSelection)
	 */
