...
/**
 *  Scanner for FTL 'if' <#if... >.
 *
 */
public class FreemarkerIfTagScanner extends
		AbstractFreemarkerDirectiveScanner {

	public FreemarkerIfTagScanner(TagSyntaxProvider tagSyntaxProvider,
			IColorManager manager, IPreferenceStore store) {
		super(IF_DIRECTIVE, tagSyntaxProvider, manager, store);
		initialize();
	}
}
