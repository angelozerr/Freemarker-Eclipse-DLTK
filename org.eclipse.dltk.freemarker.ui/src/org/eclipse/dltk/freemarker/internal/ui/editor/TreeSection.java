...
public abstract class TreeSection<T extends FreemarkerFormPage> extends
		StructuredViewerSection<T> {
	 ...
	 * @param formPage
	 */
	public TreeSection(T formPage, Composite parent, int style,
			String[] buttonLabels) {
