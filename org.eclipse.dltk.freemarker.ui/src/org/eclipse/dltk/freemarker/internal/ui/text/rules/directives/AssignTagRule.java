...
/**
 *  JFace {@link IRule} for FTL 'assign' <#assign... >.
 *
 */
public class AssignTagRule extends DirectiveRule {

	public AssignTagRule(TagSyntaxProvider tagSyntaxProvider, IToken token) {
