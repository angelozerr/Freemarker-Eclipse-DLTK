...
public interface DebuggedEnvironment extends DebugModel {
	...
	/**
	 * Stops the processing of the environment after it was stopped on a
	 * breakpoint. Causes a {@link freemarker.core.StopException} to be thrown
	 * in the processing thread in the remote VM.
	 * 
	 * @throws RemoteException
	 */
	...
	/**
	 * Returns the (debugged) variable that is visible in this contextSee
	 * {@link Environment#getVariable(String)} for more information.
	 * 
	 * @param varName
	 * @return
	 */
	public DebugModel getVariable(String name) throws RemoteException;

	/**
	 * Return global variables names of the debugged environnement.
	 * 
	 * @return
	 */
	...
	/**
	 * Return local variables names of the debugged environnement.
	 * 
	 * @return
	 */
	Collection<String> getLocalVariableNames() throws RemoteException;
}
