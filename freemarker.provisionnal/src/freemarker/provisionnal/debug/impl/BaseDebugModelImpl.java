 ...
 */
public class BaseDebugModelImpl implements DebugModel
{
    ...
    public BaseDebugModelImpl(TemplateModel model, int extraTypes, IDebugModelFactory modelFactory) throws RemoteException
    {
        super();
        this.model = model;
    ...
    private DebugModel getDebugModel(TemplateModel tm) throws RemoteException
    {
        return (DebugModel)BaseDebuggedEnvironmentImpl.getCachedWrapperFor(tm, modelFactory);
    }
