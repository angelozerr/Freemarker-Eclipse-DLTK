 ...
 * 
 */
public class ProjectModelInstanceProvider extends ModelInstanceProvider
		implements IProjectObjectInstanceProvider {
	...
	public ProjectModelInstanceProvider(IResource resource,
